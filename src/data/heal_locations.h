static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_TEST_MAP - 1] = {MAP_GROUP(TEST_MAP), MAP_NUM(TEST_MAP), 0, 0},
    [HEAL_LOCATION_SNOWVILLAGE_NO_GRAVEYARD - 1] = {MAP_GROUP(SNOWVILLAGE_NO_GRAVEYARD), MAP_NUM(SNOWVILLAGE_NO_GRAVEYARD), 12, 25},
};
